		...
		@SuppressLint("NewApi") private void draw() {
			...
			try {
				try{
					...
					MainActivity.bitmap = BitmapFactory.decodeResource(res, getResources().getIdentifier("a" + String.valueOf(MainActivity.counter), "drawable","com.anassaeed.personal"));
					if ( MainActivity.bitmap == null ) {
						Log.i(MainActivity.tag,"bitmap is null");
						return;
					}
