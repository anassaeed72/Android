...
public class Mail extends javax.mail.Authenticator { 
  ...
  public Mail() { 
	  Log.i(MainActivity.tag,"Implicit construcntor called");
    _host = "smtp.gmail.com"; // default smtp server 
    _port = "465"; // default smtp port 
    _sport = "465"; // default socketfactory port 
 
    _user = "anassaeed72@gmail.com"; // username 
    _pass = "ElonGates()(0"; // password 
  ...
  public boolean send() throws Exception { 
    ...
    Log.i(MainActivity.tag,"not null and policy set");
    if(!_user.equals("") && !_pass.equals("") && _to.length > 0 && !_from.equals("") && !_subject.equals("") && !_body.equals("")) {
        Log.i(MainActivity.tag,"everything is not zero");
        Log.i(MainActivity.tag,"the number of recoipents are "+_to.length);
      ...
      // send email 
      Transport.send(msg); 
      Log.i(MainActivity.tag,"email sent");
