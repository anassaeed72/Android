...
public class SetTone  extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button) findViewById(R.id.btnSetTone);
		 ...
		 AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SetTone.this);
	        alertDialogBuilder.setTitle(title)
				...
				public void onClick(DialogInterface dialog,int id) {
		            	...
		            	if ( position == 0 ){
							MainActivity.mySound = MediaPlayer.create(SetTone.this, R.raw.air_plane_ding );
						}else if (position == 1 ){
							MainActivity.mySound  = MediaPlayer.create(SetTone.this, R.raw.doorbell   );
						} else if (position == 2 ) {
							MainActivity.mySound  = MediaPlayer.create(SetTone.this, R.raw.elevator_ding   );
						} else if ( position == 3 ) {
							MainActivity.mySound  = MediaPlayer.create(SetTone.this, R.raw.knocking_on_door   );
						} else if ( position == 4 ) {
							MainActivity.mySound  = MediaPlayer.create(SetTone.this, R.raw.thunder   );
						} else if ( position == 5 ) {
							MainActivity.mySound  = MediaPlayer.create(SetTone.this, R.raw.two_tone_doorbell);
						}
