...
public class SetNumber extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SetNumber.this.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_HIDE_NAVIGATION);
        executeDelayed();
        FullScreencall();
        ...
        button.setOnClickListener(new OnClickListener() {  
            ...
            public void onClick(View view) {
            	...
            	Toast.makeText(SetNumber.this, "Number Saved "+temp, Toast.LENGTH_SHORT).show();
            		Intent intent = new Intent(SetNumber.this, MainActivity.class);
